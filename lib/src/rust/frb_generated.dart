...
import 'api/colorizer/colorize.dart';
import 'api/colorizer/main.dart';
import 'api/colorizer/types.dart';
import 'api/colorizer/utils.dart';
...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 2019820323;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<RgbImage> crateApiColorizerColorizeColorize({
    required DynamicImage img,
    required AppConfig config,
  });

  Future<Uint8List> crateApiColorizerMainColorizeImage({
    required List<int> image,
    required AppConfig config,
  });

  Future<List<List<(double, double, double)>>>
  crateApiColorizerUtilsComputeIntegralImage({required RgbImage image});
  ...
  Future<SrgbF32> crateApiColorizerUtilsHexToRgb({required String input});

  Future<Lab> crateApiColorizerUtilsInterpolateColor({
    required Lab color1,
    required Lab color2,
    required double t,
  });

  Future<List<Lab>> crateApiColorizerMainLoadColorscheme({
  ...
  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_Lab;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_Lab;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_LabPtr;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_RgbImage;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_RgbImage;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_RgbImagePtr;

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_SrgbF32;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_SrgbF32;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_SrgbF32Ptr;
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<RgbImage> crateApiColorizerColorizeColorize({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateApiColorizerColorizeColorizeConstMeta,
        argValues: [img, config],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiColorizerColorizeColorizeConstMeta =>
      const TaskConstMeta(debugName: "colorize", argNames: ["img", "config"]);
  ...
  Future<Uint8List> crateApiColorizerMainColorizeImage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiColorizerMainColorizeImageConstMeta,
        argValues: [image, config],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiColorizerMainColorizeImageConstMeta =>
      const TaskConstMeta(
        debugName: "colorize_image",
        argNames: ["image", "config"],
      );
  ...
  crateApiColorizerUtilsComputeIntegralImage({required RgbImage image}) {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
            image,
            serializer,
          );
          pdeCallFfi(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_list_record_f_64_f_64_f_64,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiColorizerUtilsComputeIntegralImageConstMeta,
        argValues: [image],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiColorizerUtilsComputeIntegralImageConstMeta =>
      const TaskConstMeta(
        debugName: "compute_integral_image",
        argNames: ["image"],
      );
  ...
  Future<SrgbF32> crateApiColorizerUtilsHexToRgb({required String input}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiColorizerUtilsHexToRgbConstMeta,
        argValues: [input],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiColorizerUtilsHexToRgbConstMeta =>
      const TaskConstMeta(debugName: "hex_to_rgb", argNames: ["input"]);
  ...
  Future<Lab> crateApiColorizerUtilsInterpolateColor({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
            color1,
            serializer,
          );
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiColorizerUtilsInterpolateColorConstMeta,
        argValues: [color1, color2, t],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiColorizerUtilsInterpolateColorConstMeta =>
      const TaskConstMeta(
        debugName: "interpolate_color",
        argNames: ["color1", "color2", "t"],
      );
  ...
  Future<List<Lab>> crateApiColorizerMainLoadColorscheme({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_list_String(colors, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 12,
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiColorizerMainLoadColorschemeConstMeta,
        argValues: [colors],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiColorizerMainLoadColorschemeConstMeta =>
      const TaskConstMeta(debugName: "load_colorscheme", argNames: ["colors"]);
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_Lab => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_Lab => wire
      .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_RgbImage => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_RgbImage => wire
      .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage;

  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_SrgbF32 => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_SrgbF32 => wire
      .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32;
  ...
  @protected
  Lab
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return LabImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  @protected
  RgbImage
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return RgbImageImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }

  @protected
  SrgbF32
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return SrgbF32Impl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  @protected
  Lab
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return LabImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  RgbImage
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return RgbImageImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  Lab
  dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return LabImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  RgbImage
  dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return RgbImageImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  SrgbF32
  dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return SrgbF32Impl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  AppConfig dco_decode_app_config(dynamic raw) {
    ...
    return AppConfig(
      blendFactor: dco_decode_f_32(arr[0]),
      colors:
          dco_decode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
            arr[1],
          ),
      ditherAmount: dco_decode_f_32(arr[2]),
      spatialAveragingRadius: dco_decode_u_32(arr[3]),
    );
  }
  ...
  @protected
  List<List<(double, double, double)>>
  dco_decode_list_list_record_f_64_f_64_f_64(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_list_record_f_64_f_64_f_64)
        .toList();
  }
  ...
  @protected
  List<(double, double, double)> dco_decode_list_record_f_64_f_64_f_64(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_record_f_64_f_64_f_64)
        .toList();
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return LabImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return RgbImageImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return SrgbF32Impl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  @protected
  Lab
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return LabImpl.frbInternalSseDecode(
  ...
  @protected
  RgbImage
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return RgbImageImpl.frbInternalSseDecode(
  ...
  @protected
  Lab
  sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return LabImpl.frbInternalSseDecode(
  ...
  @protected
  RgbImage
  sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return RgbImageImpl.frbInternalSseDecode(
  ...
  @protected
  SrgbF32
  sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return SrgbF32Impl.frbInternalSseDecode(
  ...
  AppConfig sse_decode_app_config(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_blendFactor = sse_decode_f_32(deserializer);
    var var_colors =
        sse_decode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
          deserializer,
        );
    var var_ditherAmount = sse_decode_f_32(deserializer);
    var var_spatialAveragingRadius = sse_decode_u_32(deserializer);
    return AppConfig(
      blendFactor: var_blendFactor,
      colors: var_colors,
      ditherAmount: var_ditherAmount,
      spatialAveragingRadius: var_spatialAveragingRadius,
    );
  }
  ...
  @protected
  List<List<(double, double, double)>>
  sse_decode_list_list_record_f_64_f_64_f_64(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <List<(double, double, double)>>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_list_record_f_64_f_64_f_64(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<(double, double, double)> sse_decode_list_record_f_64_f_64_f_64(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_record_f_64_f_64_f_64(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  void
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    Lab self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as LabImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  @protected
  void
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    RgbImage self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as RgbImageImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  @protected
  void
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32(
    SrgbF32 self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as SrgbF32Impl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as LabImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as RgbImageImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  @protected
  void
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
    Lab self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as LabImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  @protected
  void
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRgbImage(
    RgbImage self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as RgbImageImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  @protected
  void
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSrgbf32(
    SrgbF32 self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as SrgbF32Impl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_app_config(AppConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_f_32(self.blendFactor, serializer);
    sse_encode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLab(
      self.colors,
      serializer,
    );
    sse_encode_f_32(self.ditherAmount, serializer);
    sse_encode_u_32(self.spatialAveragingRadius, serializer);
  }
  ...
  @protected
  void sse_encode_list_list_record_f_64_f_64_f_64(
    List<List<(double, double, double)>> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_list_record_f_64_f_64_f_64(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_list_record_f_64_f_64_f_64(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_record_f_64_f_64_f_64(item, serializer);
    }
  }
...
@sealed
class LabImpl extends RustOpaque implements Lab {
  // Not to be used by end users
  LabImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  LabImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_Lab,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_Lab,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_LabPtr,
  );
}
...
@sealed
class RgbImageImpl extends RustOpaque implements RgbImage {
  // Not to be used by end users
  RgbImageImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  RgbImageImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_RgbImage,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_RgbImage,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_RgbImagePtr,
  );
}

@sealed
class SrgbF32Impl extends RustOpaque implements SrgbF32 {
  // Not to be used by end users
  SrgbF32Impl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  SrgbF32Impl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_SrgbF32,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_SrgbF32,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_SrgbF32Ptr,
  );
}
