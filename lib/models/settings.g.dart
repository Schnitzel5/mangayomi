...
const SettingsSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'colorizeImages': PropertySchema(
      id: 33,
      name: r'colorizeImages',
      type: IsarType.bool,
    ),
...
void _settingsSerialize(
  ...
  writer.writeBool(offsets[33], object.colorizeImages);
  writer.writeLong(offsets[34], object.concurrentDownloads);
  ...
  writer.writeBool(offsets[36], object.cropBorders);
  ...
  writer.writeString(offsets[38], object.customDns);
  writer.writeString(offsets[39], object.dateFormat);
  writer.writeByte(offsets[40], object.debandingType.index);
  writer.writeLong(offsets[41], object.defaultDoubleTapToSkipLength);
  writer.writeDouble(offsets[42], object.defaultPlayBackSpeed);
  writer.writeByte(offsets[43], object.defaultReaderMode.index);
  writer.writeLong(offsets[44], object.defaultSkipIntroLength);
  ...
  writer.writeByte(offsets[46], object.disableSectionType.index);
  writer.writeByte(offsets[47], object.displayType.index);
  writer.writeLong(offsets[48], object.doubleTapAnimationSpeed);
  writer.writeString(offsets[49], object.downloadLocation);
  writer.writeBool(offsets[50], object.downloadOnlyOnWifi);
  writer.writeBool(offsets[51], object.downloadedOnlyMode);
  writer.writeBool(offsets[52], object.enableAniSkip);
  writer.writeBool(offsets[53], object.enableAudioPitchCorrection);
  writer.writeBool(offsets[54], object.enableAutoSkip);
  writer.writeBool(offsets[55], object.enableCustomColorFilter);
  writer.writeBool(offsets[56], object.enableDiscordRpc);
  writer.writeBool(offsets[57], object.enableGpuNext);
...
Settings _settingsDeserialize(
  ...
  final object = Settings(
    ...
    colorizeImages: reader.readBoolOrNull(offsets[33]),
    concurrentDownloads: reader.readLongOrNull(offsets[34]),
    ...
    cropBorders: reader.readBoolOrNull(offsets[36]),
    customColorFilter: reader.readObjectOrNull<CustomColorFilter>(
      offsets[37],
      CustomColorFilterSchema.deserialize,
      allOffsets,
    ),
    customDns: reader.readStringOrNull(offsets[38]),
    dateFormat: reader.readStringOrNull(offsets[39]),
    debandingType:
    ...
    defaultReaderMode:
        ...
        ReaderMode.vertical,
    defaultSkipIntroLength: reader.readLongOrNull(offsets[44]),
    disableSectionType:
        ...
        SectionType.all,
    displayType:
        _SettingsdisplayTypeValueEnumMap[reader.readByteOrNull(offsets[47])] ??
        DisplayType.compactGrid,
    doubleTapAnimationSpeed: reader.readLongOrNull(offsets[48]),
    downloadLocation: reader.readStringOrNull(offsets[49]),
    downloadOnlyOnWifi: reader.readBoolOrNull(offsets[50]),
    downloadedOnlyMode: reader.readBoolOrNull(offsets[51]),
    enableAniSkip: reader.readBoolOrNull(offsets[52]),
    enableAudioPitchCorrection: reader.readBoolOrNull(offsets[53]),
    enableAutoSkip: reader.readBoolOrNull(offsets[54]),
    enableCustomColorFilter: reader.readBoolOrNull(offsets[55]),
    enableDiscordRpc: reader.readBoolOrNull(offsets[56]),
    enableGpuNext: reader.readBoolOrNull(offsets[57]),
...
extension SettingsQueryFilter
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition>
  colorizeImagesIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'colorizeImages'),
      );
    });
  }

  QueryBuilder<Settings, Settings, QAfterFilterCondition>
  colorizeImagesIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'colorizeImages'),
      );
    });
  }

  QueryBuilder<Settings, Settings, QAfterFilterCondition> colorizeImagesEqualTo(
    bool? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'colorizeImages', value: value),
      );
    });
  }
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByColorizeImages() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorizeImages', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByColorizeImagesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorizeImages', Sort.desc);
    });
  }
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByColorizeImages() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorizeImages', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByColorizeImagesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorizeImages', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByColorizeImages() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'colorizeImages');
    });
  }
...
extension SettingsQueryProperty
  ...
  QueryBuilder<Settings, bool?, QQueryOperations> colorizeImagesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'colorizeImages');
    });
  }
