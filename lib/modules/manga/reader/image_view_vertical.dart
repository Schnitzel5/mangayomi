...
class ImageViewVertical extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // A constant filter quality is deliberate: toggling low/medium via the
    // shared isScrolling notifier rebuilt every built page twice per scroll
    // gesture, which cost more than the cheaper scroll-time sampling saved.
